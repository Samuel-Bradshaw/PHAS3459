...
public class NumericalReader { 
	...
	void analysisStart(String dataFile) throws IOException{ 
		//NEXT LINE NEEDS CHANGING TO WHERE WE WANT THE FILE TO BE STORED 
		String datafile1 = ("N:" + File.separator + "mywork" + File.separator + dataFile); 
		File outputfile = new File(datafile1); 
		FileWriter fw = new FileWriter(outputfile); 
		//Initialising values -NEEDS T0 BE PRIVATE? 
		double minValue; 
		double maxValue; 
		double nValues; 
		double sumOfValues;  
	...
	void analyseData(String line){ 
		...
		if( line.trim().isEmpty() || Character.isLetter(firstCharacterOfLine) ){ 
		}  
